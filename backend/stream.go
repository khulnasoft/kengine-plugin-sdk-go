...
import (
	...
	"github.com/khulnasoft/kengine-plugin-sdk-go/genproto/pluginv2"

	"github.com/khulnasoft/kengine-plugin-sdk-go/data"
)
...
type StreamHandler interface {
	...
	// options with Khulnasoft Core. As soon as first subscriber joins channel RunStream
	// will be called.
...
// SubscribeStreamRequest is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
...
// SubscribeStreamResponse is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
...
// PublishStreamRequest is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
...
// PublishStreamResponse is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
type PublishStreamResponse struct {
	Status PublishStreamStatus
	Data   json.RawMessage
}

// RunStreamRequest is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
...
// StreamPacket is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
type StreamPacket struct {
	Data json.RawMessage
}

// StreamPacketSender is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
type StreamPacketSender interface {
	Send(*StreamPacket) error
}

// StreamSender allows sending data to a stream.
// StreamSender is EXPERIMENTAL and is a subject to change till Khulnasoft 8.
