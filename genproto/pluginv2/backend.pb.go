...
type PluginContext struct {
	...
	// The Khulnasoft organization id the request originates from.
	...
	// The Khulnasoft user the request originates from.
	//
	...
	// In Khulnasoft an app instance is an enabled app plugin in a
	// Khulnasoft organization.
	//
	...
	// settings. In Khulnasoft a data source instance is a created data source
	// in a Khulnasoft organization.
	//
	...
	// The khulnasoft configuration as a map of key/value pairs.
	KengineConfig map[string]string `protobuf:"bytes,6,rep,name=kengineConfig,proto3" json:"kengineConfig,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	// The user agent of the Khulnasoft server that initiated the gRPC request.
...
func (x *PluginContext) GetKengineConfig() map[string]string {
	if x != nil {
		return x.KengineConfig
	}
	return nil
}
...
type PublishStreamResponse struct {
	...
	// If empty data returned here then Khulnasoft won't publish data
...
var file_backend_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x63, 0x65, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x65, 0x74, 0x74,
	0x69, 0x6e, 0x67, 0x73, 0x12, 0x50, 0x0a, 0x0d, 0x6b, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x43,
	...
	0x74, 0x65, 0x78, 0x74, 0x2e, 0x4b, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0d, 0x6b, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65,
	...
	0x09, 0x75, 0x73, 0x65, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x1a, 0x40, 0x0a, 0x12, 0x4b, 0x65,
	0x6e, 0x67, 0x69, 0x6e, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x45, 0x6e, 0x74, 0x72, 0x79,
...
var file_backend_proto_goTypes = []interface{}{
	...
	nil,                                    // 27: pluginv2.PluginContext.KengineConfigEntry
...
var file_backend_proto_depIdxs = []int32{
	...
	27, // 5: pluginv2.PluginContext.kengineConfig:type_name -> pluginv2.PluginContext.KengineConfigEntry
